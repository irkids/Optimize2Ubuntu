...
deploy_vpn_server() {
    ...
    sudo curl -L https://raw.githubusercontent.com/irkids/Optimize2Ubuntu/refs/heads/main/codedpyscript.sh -o /opt/vpn_server/codedpyscript.sh
    
    # Set permissions
    sudo chown nobody:nogroup /opt/vpn_server/codedpyscript.sh
    sudo chmod 755 /opt/vpn_server/codedpyscript.sh
...
ExecStart=/root/vpn_server_env/bin/python3 /opt/vpn_server/codedpyscript.sh
Restart=on-failure
